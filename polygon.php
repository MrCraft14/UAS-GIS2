...
if (isset($_POST['simpan'])) {
    ...
    $queryResult = $conn->query("INSERT INTO polygon(nama,warna,poligon) VALUES('$nama','$warna','$poligon')");
    if ($queryResult) {
...
<div class="page-content p-5" id="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mt-2">
            <div class="card">
                <div class="card-header">Data Polygon</div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td><?= $no += 1; ?></td>
                                        <td><?= $row[1]; ?></td>
                                        <td><a href="delete_polygon.php?id=<?= $row[0]; ?>" class="btn btn-danger btn-hapus-kecamatan">
