...
if (isset($_POST['simpan'])) {
    ...
    $query = $conn->query("UPDATE marker SET nama='$nama', pemilik='$pemilik', alamat='$alamat', latitude='$latitude', longitude='$longitude' WHERE id='$id'");
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $id = $_GET['id'];
                    $query = $conn->query("SELECT * FROM marker WHERE id='$id'");
                    $latitude = '';
                    $longitude = '';
                    if ($query->num_rows > 0) {
                        $row = $query->fetch_row();
